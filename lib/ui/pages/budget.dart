...
import 'package:mbecek/ui/pages/addBudget.dart';
...
class _BudgetState extends State<Budget> {
  ...
  List<Map<String, dynamic>> budgetDetails = [
    ...
    {
      "name": "Banquet invitations and accessories",
      "type": "Accessories",
      "status": "Pending",
      "paid": "0",
      "date": "2022-09-20"
                  ...
                  itemBuilder: (context, index) => Padding(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: Text("Paid: ${budgetDetails[index]['paid']}"),
                      ),
                    ),
                  ),
                ),
